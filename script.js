  ...
  grid.innerHTML = filtered
    .map(
      ...
      <div class="card">
        ...
        ${p.image ? `<div class="card-image-wrap"><img src="${p.image}" class="card-image" alt="${p.title}" /></div>` : ''}
        ...
        <div class="card-actions">
          ...
          <a href="${p.link ? p.link + '/archive/refs/heads/main.zip' : '#'}" target="_blank" class="action-btn download-btn">
